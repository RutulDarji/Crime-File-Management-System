...
<div class="wrapper row2 bgded" style="background-image:url('images/demo/backgrounds/Crime Scene Wallpaper - 9186.jpg')">
  <div class="overlay"> 
    <!-- ################################################################################################ -->
    <div id="intro">
     <img src="images/news_related/samridh.jpg" style=" height:300px; width:300px; ">
      <h4 class="nospace font-x3">Cheating case: Now, Samruddha CMD Mahesh Motewar arrested</h4>
