...
<center>
<a href="complain_table_jsp.jsp"> ADD </a>
</center>
...
if(complainBeanlist!=null)
{
	for(int i=0;i<complainBeanlist.size();i++)
	{
		...
		%>
		 ...
		 <td><a href="complain_delete?complain_id=<%= complainBeanObj.getComplain_id() %>">Delete</a> &nbsp;&nbsp;&nbsp; <a href="complain_edit?complain_id=<%= complainBeanObj.getComplain_id() %>">Edit</a>&nbsp;&nbsp;&nbsp;<a href="complain_view?complain_id=<%= complainBeanObj.getComplain_id() %>">View</a>
		 </tr>
