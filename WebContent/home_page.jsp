  ...
  <div class="overlay"> 
    ...
    <div id="intro">
      ...
      <ul class="nospace">
        ...
        <li><a href="user_email_verification.jsp">Registration</a></li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
    ...
    <div class="clear">
      <div class="one_quarter first center">
       ...
       <!--   <p>Aenean semper elementum tellus, ut placerat leo. Quisque vehicula, urna sit amet pulvinar dapibus dui leo.</p>
		-->
		<a href="Newsfeed1.jsp">Read More...</a>
   </div>
      <div class="one_quarter center">
        ...
        <!--  <p>Aenean semper elementum tellus, ut placerat leo. Quisque vehicula, urna sit amet pulvinar dapibus dui leo.</p>
		-->
		<a href="newsfeed2_cyber_crime.jsp">Read More...</a>
	  </div>
      <div class="one_quarter center">
        ...
        <!--  <p>Aenean semper elementum tellus, ut placerat leo. Quisque vehicula, urna sit amet pulvinar dapibus dui leo.</p>
		-->
		<a href="newsfeed3_delhi_gang.jsp">Read More...</a>
	  </div>
      <div class="one_quarter center">
        ...
        <!--  <p>Aenean semper elementum tellus, ut placerat leo. Quisque vehicula, urna sit amet pulvinar dapibus dui leo.</p>
		-->
		<a href="newsfeed4_cheating.jsp">Read More...</a>
	  </div>
    </div>
    <!-- ################################################################################################ -->
    <!-- / container body -->
