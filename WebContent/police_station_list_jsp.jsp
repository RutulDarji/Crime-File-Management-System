...
<center>
<a href="police_station_jsp.jsp"> ADD </a>
</center>
...
if(police_stationlist!=null)
{
	for(int i=0;i<police_stationlist.size();i++)
	{
		...
		%>
		 ...
		 <td><a href="police_station_delete?police_station_id=<%= police_station.getPolice_station_id() %>">Delete</a> &nbsp;&nbsp;&nbsp; <a href="police_station_edit?police_station_id=<%= police_station.getPolice_station_id() %>">Edit</a>&nbsp;&nbsp;&nbsp;<a href="police_station_view?police_station_id=<%= police_station.getPolice_station_id() %>">View</a>
		 </tr>
