...
<form action="police_station_update" name="police_station_edit_form" id="police_station_edit_form">
<input type="hidden" name="police_station_id" id="police_station_id" value="${police_station_BeanObj.police_station_id}">
<table>
...
police_station_Bean police_station_BeanObj=(police_station_Bean)request.getAttribute("police_station_BeanObj");
String police_station_BeanObj_area_id=police_station_BeanObj.getArea_id();
String AreaBeanlist_area_id=new String();
...
if(AreaBeanlist!=null)
{
	...
	{	
		...
		AreaBeanlist_area_id=area.getArea_id();
		
		if(area!=null)
		{
			if(police_station_BeanObj_area_id.equals(AreaBeanlist_area_id))
			{
				%>
...
String police_station_BeanObj_station_name=police_station_BeanObj.getPolice_station_name();
String police_stationlist_station_name=new String();
...
if(police_stationlist!=null)
{
	...
	{	
		...
		police_stationlist_station_name=police_station.getPolice_station_name();
		
		if(police_station!=null)
		{
			if(police_station_BeanObj_station_name.equals(police_stationlist_station_name))
			{
				%>
				<option value="<%= police_station.getPolice_station_name() %>" selected="selected"><%= police_station.getPolice_station_name()  %></option>
				<%
			}
			else
			{
				%>
				<option value="<%= police_station.getPolice_station_name() %>"><%= police_station.getPolice_station_name()  %></option>
				<%
			}
		}//nested if
	}//for
