...
<div class="wrapper row2 bgded" style="background-image:url('images/demo/backgrounds/Crime Scene Wallpaper - 9186.jpg')">
  <div class="overlay"> 
    <!-- ################################################################################################ -->
    <div id="intro">
	<h2 class=nonspace font-x3">Query Table</h2>
	
<center>	
	<form action="user_query_insert" name="query_table_form" id="query_table_form">
...
<td><textarea row="3" placeholder="Enter Details" name="query_details" id="text3"></textarea>
<td>${ query_details }
</tr>
...
<td>
<select name="query_status_id" id="query_status_id" enable="false">
<%
