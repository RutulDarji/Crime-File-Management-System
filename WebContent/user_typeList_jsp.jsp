...
<center>
<a href="user_type_table.jsp"> ADD </a>
</center>
...
if(user_typelist!=null)
{
	for(int i=0;i<user_typelist.size();i++)
	{
		...
		%>
		 ...
		 <td><a href="user_type_delete?user_type_id=<%= user_typeBeanObj.getUser_type_id() %>">Delete</a> &nbsp;&nbsp;&nbsp; <a href="user_type_edit?user_type_id=<%= user_typeBeanObj.getUser_type_id() %>">Edit</a>&nbsp;&nbsp;&nbsp;<a href="user_type_view?user_type_id=<%= user_typeBeanObj.getUser_type_id() %>">View</a>
		 </tr>
