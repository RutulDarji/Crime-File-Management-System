<%@page import="Mindeft.CFMS.dao.most_wanted_criminal_Dao"%>
...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    ...
    <div id="gallery">
      <figure>
        <header class="heading">MostWanted Person </header>
        <form action="" name="user_criminal_list">
        	<input type="hidden" name="criminal_id" id="criminal_id">
        <%
        List<criminalBean> criminalBeanlist=new most_wanted_criminal_Dao().select(); 
        
        if(criminalBeanlist!=null)
        {
        	for(int i=0;i<criminalBeanlist.size();i++)
        	{
        		criminalBean criminal=criminalBeanlist.get(i);
        			if(i%4==0)
        			{
        		%>
        		 <li class="one_quarter first"><a href="user_criminal_view?criminal_id=<%= criminal.getCriminal_id() %>"><img alt="NO IMAGE FOUND TO DISPLAY" src="./upload/criminal/<%=criminal.getCriminal_image()%>" style="height:220px; width:220px; "></a><br><a href="user_criminal_view?criminal_id=<%= criminal.getCriminal_id() %>"><p><center> <%= criminal.getCriminal_firstname() + " " +criminal.getCriminal_middlename() + " " +criminal.getCriminal_lastname() %> </center></p></a></li>
        	    <% 
        			}
        			else
        			{
        				%>
               		 	<li class="one_quarter"><a href="user_criminal_view?criminal_id=<%= criminal.getCriminal_id() %>"><img alt="NO IMAGE FOUND TO DISPLAY" src="./upload/criminal/<%=criminal.getCriminal_image()%>" style="height:220px; width:220px; "></a><br><a href="user_criminal_view?criminal_id=<%= criminal.getCriminal_id() %>"><p><center> <%= criminal.getCriminal_firstname() + " " +criminal.getCriminal_middlename() + " " +criminal.getCriminal_lastname() %> </center></p></a></li>
               	    	<%	
        			}
        	} 
