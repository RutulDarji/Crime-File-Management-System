...
function witness()
{
	...
	var f=document.crime_witness_form;
	
	f.action="user_crime_add_another_witness";
...
<h2 class=nonspace font-x3">Crime Witness</h2>

<center>

<form action="user_crime_witness" name="crime_witness_form" id="crime_witness_form" method="post" enctype="multipart/form-data">
...
<th>Gender::
<td>
<input type="radio" name="crime_witness_gender" id="abc" value="male"><font color="white" style="position:absolute;left:720px;top:470px;">male</font>
<input type="radio" name="crime_witness_gender" id=abc1 value="female"><font color="white" style="position:absolute;left:810px;top:470px;">female </font>
...
<tr>
<th>Address:
<td><textarea row="3"  placeholder="enter Address" name="crime_witness_address" id="text3">v${crime_witnessBeanObj.crime_witness_address }</textarea>
...
<input type="button" name="btnadd"  value="SUBMIT AND ANOTHER ONE" class="button button4" onclick="witness();"> &nbsp;&nbsp;&nbsp;
</tr>

<tr>
<td colspan="3">
<center>
<a href="user_crime_victim.jsp"><input type="button" name="btnadd"  value="SKIP & NEXT-->" class="button button4"></a> &nbsp;&nbsp;&nbsp;
</center>
</tr>
