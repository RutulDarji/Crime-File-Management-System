<%@page import="Mindeft.CFMS.dao.userDao"%>
...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    ...
    <div id="gallery">
<center>      
      <form action="" id="user_profile_page" name="user_profile_page">
...
<%
List<userBean> userBeanlist=new userDao().view_particular(session_userBeanObj.getUser_id());
if(userBeanlist!=null)
{
	for(int i=0;i<userBeanlist.size();i++)
	{
		userBean user=userBeanlist.get(i);
		%> 

		
		 <img style="height:220px; width:220px;  alt="NO IMAGE FOUND TO DISPLAY" src="./upload/user_image/<%= user.getUser_image() %>">
		 <br><br><br>
		...
		<table>
		 ...
		 <td align="center"><%= user.getUser_firstname() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Middlename</td>
		 <td align="center"><%= user.getUser_middlename() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Lastname</td>
		 <td align="center"><%= user.getUser_lastname() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Gender</td>
		 <td align="center"><%= user.getGender() %>
		 </tr>
		 ...
		 <td align="center"><%= user.getAddress() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Date Of Birth</td>
		 <td align="center"><%= user.getDate_of_birth() %>
		 </tr>
		...
		<tr>
		<td colspan="2" align="center"><a href="user_edit?user_id=${ session_userBeanObj.user_id}">Edit Profile</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="user_change_password.jsp">Change Password</a>
		</tr>		
