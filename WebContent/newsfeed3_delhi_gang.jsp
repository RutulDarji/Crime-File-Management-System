...
<div class="wrapper row2 bgded" style="background-image:url('images/demo/backgrounds/Crime Scene Wallpaper - 9186.jpg')">
  <div class="overlay"> 
    <!-- ################################################################################################ -->
    <div id="intro">
     <img src="images/news_related/rape-pregnant.jpg" style=" height:300px; width:300px; ">
      <h4 class="nospace font-x3">Delhi shocker! Woman gang-raped by five in flat, jumps off balcony to escape</h4>
      <!-- <p class="nospace font-x2">Aenean semper elementum tellus ut placerat</p>-->
      <p class="nospace btmspace-50">
    	A young woman was allegedly gang-raped by five persons, including one known to her, here on Sunday and she finally escaped by jumping off the balcony of the first floor flat, police said.
