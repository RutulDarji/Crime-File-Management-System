...
function victim()
{
	...
	var f=document.crime_victim_form;
	
	f.action="user_crime_add_another_victim";
...
<h2 class=nonspace font-x3">Crime Victim</h2>


<form action="user_crime_victim_insert" name="crime_victim_form" id="crime_victim_form" method="post" enctype="multipart/form-data">
<center>
<table>
...
<th>Gender::
<td>
<input type="radio" name="crime_victim_gender" id="crime_victim_gender" value="male" class="abc">male
<input type="radio" name="crime_victim_gender" id="crime_victim_gender" value="female" class="abc1">female 
...
<th>Gender::
<td>
<input type="radio" name="crime_victim_gender" id="abc" value="male"><font color="white" style="position:absolute;left:720px;top:470px;">male</font>
<input type="radio" name="crime_victim_gender" id="abc1" value="female"><font color="white" style="position:absolute;left:810px;top:470px;">female </font>
...
<tr>
<td colspan="3"><input type="submit" name="btnsubmit" id="btnsubmit" value="SUBMIT AND NEXT" class="button button4">
&nbsp;&nbsp;&nbsp;
<input type="button" name="btnadd"  value="ADD OTHER VICTIM" class="button button4" onclick="victim();"> &nbsp;&nbsp;&nbsp;
</tr>

<tr>
<td colspan="3">
<center>
<a href="user_crime_evidence.jsp"><input type="button" name="btnadd"  value="SKIP & NEXT-->" class="button button4"></a> &nbsp;&nbsp;&nbsp;
</center>
</tr>
