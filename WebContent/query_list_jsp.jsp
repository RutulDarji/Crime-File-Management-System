...
<center>
<a href="query_table_jsp.jsp"> ADD </a>
</center>
...
if(queryBeanlist!=null)
{
	for(int i=0;i<queryBeanlist.size();i++)
	{
		...
		%>
		 ...
		 <td><a href="query_delete?query_id=<%= queryBeanObj.getQuery_id() %>">Delete</a> &nbsp;&nbsp;&nbsp; <a href="query_edit?query_id=<%= queryBeanObj.getQuery_id() %>">Edit</a>&nbsp;&nbsp;&nbsp;<a href="query_view?query_id=<%= queryBeanObj.getQuery_id() %>">View</a>
		 </tr>
