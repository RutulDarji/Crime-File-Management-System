...
<h2 class=nonspace font-x3">Crime</h2>

<form action="user_crime_page" name="crime_form" id="crime_form">
<center>
<table>
...
<th>Select Crime
<td>
<select name="CrimeType_Id" class="text3">
 <%
...
<th>Select Area:
<td>
<select name="area_id" id="area_id" class="text3">
...
<th> Select Area:
<td> 
<select name="area_id" class="text3"> 
<%
...
<tr>
<th>Date Of Crime :
<td><input type="date" name="crime_date" class="text3">
<td>${ crime_date }
</tr>

<tr>
<th>Crime Detail :
<td><textarea row="3" name="crime_details" class="text3">${ crimeBeanObj.crime_details }</textarea>
<td>${ crime_details }
</tr>

<tr>
<th>Location Description :
<td><textarea row="3" name="location_description" class="text3">${ crimeBeanObj.location_description }</textarea>
<td>${ location_description }
</tr>
 
<tr>
<td colspan="2"><center><input type="submit" name="btnsubmit" id="btnsubmit" value="Next"  class="button button4"></center></td>
</tr>
