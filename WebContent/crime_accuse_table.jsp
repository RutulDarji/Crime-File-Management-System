...
<form action="crime_accuse_insert" name="crime_accuse_form" id="crime_accuse_form" method="post" enctype="multipart/form-data">
...
<th>Gender::
<td>
<input type="radio" name="crime_accuse_gender" id="crime_accuse_gender" value="male">male
<input type="radio" name="crime_accuse_gender" id="crime_accuse_gender" value="female">female 
