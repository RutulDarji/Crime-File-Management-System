...
<div class="wrapper row2 bgded" style="background-image:url('images/demo/backgrounds/Crime Scene Wallpaper - 9186.jpg')">
  <div class="overlay"> 
    <!-- ################################################################################################ -->
    <div id="intro">
     <img src="images/news_related/Cyber-Crime.jpg" style=" height:300px; width:300px; ">
      <h4 class="nospace font-x3">The government has recently said in Rajya Sabha that 1,600 arrests have been made related to cyber crimes</h4>
