...
<center>
<a href="security_question_table_jsp.jsp"> ADD </a>
</center>
...
if(security_question_list!=null)
{
	for(int i=0;i<security_question_list.size();i++)
	{
		...
		%>
		 ...
		 <td><a href="security_question_delete?security_question_id=<%= security_question.getSecurity_question_id() %>">Delete</a> &nbsp;&nbsp;&nbsp; <a href="security_question_edit?security_question_id=<%= security_question.getSecurity_question_id() %>">Edit</a>&nbsp;&nbsp;&nbsp;<a href="security_question_view?security_question_id=<%= security_question.getSecurity_question_id() %>">View</a>
		 </tr>
