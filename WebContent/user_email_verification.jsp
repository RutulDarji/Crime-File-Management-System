...
<h2 class=nonspace font-x3">Email Verification</h2>
...
<tr>
<td>Enter Email::
<td><input type="text" class="text3" name="email" id="email" value="${ email_session.email1} "> ${ email }
<td><input type="button" class="button button4" name="btnotp" value="SEND OTP" onclick="mail()">
</tr>

<tr>
<td>Enter OTP::
<td><input class="text3" type="text" name="otp" id="otp"> ${ otp }
</tr>

<tr>
<td colspan="2" align="center"><input type="submit" name="btnsubmit" id="btnsubmit" class="button button4">
</tr>
