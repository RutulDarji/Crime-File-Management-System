...
<br><br><br><br><br>
<center>
<form action="complain_status_insert" name="complain_status_table" id="complain_status_table">
<table>
...
<td> <input type="text" name="complain_status_type" id="text3" value="${ complain_status_Bean_obj.complain_status_type }"> 
