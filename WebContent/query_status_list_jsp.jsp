...
<center>
<a href="query_status_table.jsp"> ADD </a>
</center>
...
if(query_status_list!=null)
{
	for(int i=0;i<query_status_list.size();i++)
	{
		...
		%>
		 ...
		 <td><a href="query_status_delete?query_status_id=<%= query_status.getQuery_status_id() %>">Delete</a> &nbsp;&nbsp;&nbsp; <a href="query_status_edit?query_status_id=<%= query_status.getQuery_status_id() %>">Edit</a>&nbsp;&nbsp;&nbsp;<a href="query_status_view?query_status_id=<%= query_status.getQuery_status_id() %>">View</a>
		 </tr>
