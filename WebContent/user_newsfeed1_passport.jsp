...
<div class="wrapper row2 bgded" style="background-image:url('images/demo/backgrounds/Crime Scene Wallpaper - 9186.jpg')">
  <div class="overlay"> 
    <!-- ################################################################################################ -->
    <div id="intro">
     <img src="images/news_related/passport.jpg" style=" height:300px; width:300px; ">
      <h4 class="nospace font-x3">Mumbai: Man tampers with passport to hide marriage from parents, arrested</h4>
...
The report added that Chaturvedi was booked under the Indian Penal Code sections 420 cheating and dishonestly inducing delivery of property 465 forgery 468 forgery for purpose of cheating and 471 using as genuine a forged document of electronic record.   </p>
    </div>
    <!-- ################################################################################################ -->
  </div>
</div>
