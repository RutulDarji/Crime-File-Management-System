...
function evidence()
{
	...
	var f=document.evidence_form;
	
	f.action="user_crime_add_another_evidence";
...
<h2 class=nonspace font-x3">Evidence</h2>

<form action="user_evidence_insert" name="evidence_form" id="evidence_form" method="post" enctype="multipart/form-data">
<center>
<table>
...
<tr>
<th>Evidence Details :
<td><textarea row="3" placeholder="Enter Details" name="evidence_details" id="text3">${ evidenceBeanObj.evidence_details }</textarea>
<td>${ evidence_details }
</tr>
...
<tr>
<td colspan="3"><input type="submit" name="btnsubmit" id="btnsubmit" value="Submit" class="button button4">&nbsp;&nbsp;&nbsp;
<input type="button" name="btnadd"  value="ADD OTHER EVIDENCE" class="button button4" onclick="evidence();"> &nbsp;&nbsp;&nbsp;
</tr>

<tr>
<td colspan="3">
<center>
<a href="home_page_after.jsp"><input type="button" name="btnadd"  value="Finish" class="button button4"></a> &nbsp;&nbsp;&nbsp;
</center>
</tr>
