...
if(criminalBeanlist!=null)
{
	for(int i=0;i<criminalBeanlist.size();i++)
	{
		...
		%>
		 ...
		 <img style="height:220px; width:220px;  alt="NO IMAGE FOUND TO DISPLAY" src="./upload/criminal/<%= criminalBeanObj.getCriminal_image() %>">
		 <br><br><br>
	...
	<table>
		 ...
		 <tr>
		 <td align="center">Criminal Firstname</td>
		 <td align="center"><%= criminalBeanObj.getCriminal_firstname() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Criminal Middlename</td>
		 <td align="center"><%= criminalBeanObj.getCriminal_middlename() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Criminal Lastname</td>
		 <td align="center"><%= criminalBeanObj.getCriminal_lastname() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Criminal Gender</td>
		 <td align="center"><%= criminalBeanObj.getCriminal_gender() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Criminal Age</td>
		 <td align="center"><%= criminalBeanObj.getCriminal_age() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Criminal Details</td>
		 <td align="center"><%= criminalBeanObj.getCriminal_details() %>
		 </tr>
		...
		<tr>
		<td colspan="2" align="center"><a href="user_criminal_person_report?criminal_id=<%= criminalBeanObj.getCriminal_id() %>">Get Report</a>
		</tr>
		 
		 <!--  <tr>
		 <td align="center">Most Wanted</td>
		 <td align="center"><%= criminalBeanObj.getMostwanted() %>
		 </tr>
		 
		 <tr>
		 <td align="center">Police station</td>
		 <td align="center"><%= criminalBeanObj.getPolice_station_id() %>
		 </tr>-->
