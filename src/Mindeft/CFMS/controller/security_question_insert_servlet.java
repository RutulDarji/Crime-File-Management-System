...
/**
 * Servlet implementation class security_question_insert_servlet
 */
public class security_question_insert_servlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			if(security_questionDao.insert(security_questionBeanObj));
			{
