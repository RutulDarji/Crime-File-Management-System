...
/**
 * Servlet implementation class missing_person_view_servlet
 */
public class missing_person_view_servlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("missing_person_view.jsp").forward(request, response);
	}
