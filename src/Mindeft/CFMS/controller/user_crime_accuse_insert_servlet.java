...
/**
 * Servlet implementation class user_crime_accuse_insert_servlet
 */
public class user_crime_accuse_insert_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if(isError)
			{
				req.setAttribute("crime_accuseBeanObj", crime_accuseBeanObj);
				req.getRequestDispatcher("user_crime_accuse.jsp").forward(req, resp);
			}
			else
			{
				...
				if(crime_accuseDao.insert(crime_accuseBeanObj));
				{
