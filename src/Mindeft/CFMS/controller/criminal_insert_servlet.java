...
/**
 * Servlet implementation class criminal_insert_servlet
 */
public class criminal_insert_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if(isError)
			{
				req.setAttribute("criminalBeanObj", criminalBeanObj);
			...
			else
			{
				...
				if(criminalDao.insert(criminalBeanObj));
				{
