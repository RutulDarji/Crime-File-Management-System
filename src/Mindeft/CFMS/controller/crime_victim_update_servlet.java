...
/**
 * Servlet implementation class crime_victim_update_servlet
 */
public class crime_victim_update_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//System.out.println("crime_victim_insert");
		...
		try {
			...
			for (int i = 0; i < items.size(); i++)
			{
				...
				if (item.isFormField()) 
				{
					...
					if (fieldName.equalsIgnoreCase("crime_victim_id")) 
					{
						crime_victim_id = fieldValue;				
			...
			else
			{
				...
				crime_victimBeanObj.setCrime_victim_id(crime_victim_id);
				
				
				if(crime_victimDao.update(crime_victimBeanObj));
				{
