...
public class query_status_update_servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String query_status_id=new String();
		...
		{			
			...
			query_status_Bean_obj.setQuery_status_id(Integer.parseInt(query_status_id));
			query_status_Bean_obj.setQuery_status_type(query_status_type);
			
			if(query_status_Dao.update(query_status_Bean_obj))
			{
