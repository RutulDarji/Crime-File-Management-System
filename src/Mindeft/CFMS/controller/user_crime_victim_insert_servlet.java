...
/**
 * Servlet implementation class user_crime_victim_insert_servlet
 */
public class user_crime_victim_insert_servlet extends HttpServlet {
		...
		try {
			...
			else
			{
				...
				if(crime_victimDao.insert(crime_victimBeanObj));
				{
					...
					req.getRequestDispatcher("user_crime_evidence.jsp").forward(req, resp);
				}
