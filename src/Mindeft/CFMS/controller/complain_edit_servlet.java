...
/**
 * Servlet implementation class complain_edit_servlet
 */
public class complain_edit_servlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(complainBeanObj!=null)
	    {
	    	...
	    	request.getRequestDispatcher("complain_edit_jsp.jsp").forward(request, response); 
	    }
	    else
	    {
