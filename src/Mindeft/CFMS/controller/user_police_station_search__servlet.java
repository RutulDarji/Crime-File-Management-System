...
/**
 * Servlet implementation class user_police_station_search__servlet
 */
public class user_police_station_search__servlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Inside User Police Station Search");
		...
		if(isError)
		{
			request.getRequestDispatcher("user_police_station_search.jsp").forward(request, response);
		}
		else
		{
