...
/**
 * Servlet implementation class user_criminal_person_report
 */
public class user_criminal_person_report extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		criminal_id=request.getParameter("criminal_id");
			...
			*/
			...
			String path = "D:\\JavaPrg\\CrimeFileManagementSystem\\WebContent\\reports\\missingperson\\criminal_view.jrxml";
			...
			*/
			...
			JRBeanCollectionDataSource ds = new JRBeanCollectionDataSource(new criminalDao().view_particular(criminal_id),false);
