...
/**
 * Servlet implementation class user_crime_add_another_evidence_servlet
 */
public class user_crime_add_another_evidence_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if(isError)
			{
				req.setAttribute("evidenceBeanObj", evidenceBeanObj);
			...
			else
			{
				...
				if(evidenceDao.insert(evidenceBeanObj));
				{
