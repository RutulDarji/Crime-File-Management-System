...
/**
 * Servlet implementation class user_profile_update_servlet
 */
public class user_profile_update_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if(isError)
			{
				req.getRequestDispatcher("user_profile_edit.jsp").forward(req, resp);
			}
			else
			{
...
//				userBeanObj.setCity_id(city_id);
				...
				if(userDao.update_profile(userBeanObj));
				{
					System.out.println("Successful");
					req.getRequestDispatcher("user_profile_page.jsp").forward(req, resp);
				}
