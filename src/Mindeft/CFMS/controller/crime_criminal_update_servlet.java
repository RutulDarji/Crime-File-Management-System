...
/**
 * Servlet implementation class crime_criminal_update_servlet
 */
public class crime_criminal_update_servlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		crime_criminal_id=request.getParameter("crime_criminal_id");
		...
		else
		{
			...
			crime_criminalBeanObj.setCrime_criminal_id(crime_criminal_id);
			
			System.out.println(crime_criminalBeanObj.getCrime_id());
			System.out.println(crime_criminalBeanObj.getCriminal_id());
			
			if(crime_criminalDao.update(crime_criminalBeanObj))
			{
